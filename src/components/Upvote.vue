...
<template>
  <div class="w-10 h-10 bg-rectangle text-arrow rounded-lg cursor-pointer flex justify-center items-center"
    :class="{ 'bg-rectangle-selected text-arrow-selected': selected }" @click="onClick">
